    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Create Service Sub-Category</h5>

              <!-- General Form Elements -->
              <form method="POST" action="{{route('service_sub_category_create')}}" class="needs-validation" enctype="multipart/form-data" novalidate>
              @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select @error('service_category_id') is-invalid @enderror" aria-label="Default select example" id="service_category_id" name="service_category_id" required>
                      <!-- <option {{old('service_category_id') ? '' : 'selected'}} >Open this select menu</option> -->
